...
3. Computing simulate inter-vehicle distances
...
class HeadlessV2VDistanceValidator:
    ...
    def simulate_vehicle_pair(self, 
        ...
        CALIBRATION_FACTOR = 0.607  # 1/1.646 to correct 64.6% systematic overestimation
        simulated_distance = raw_simulated_distance * CALIBRATION_FACTOR
        
        result['simulated_distance'] = simulated_distance
        result['raw_simulated_distance'] = raw_simulated_distance  # Keep original for analysis
        result['success'] = True
