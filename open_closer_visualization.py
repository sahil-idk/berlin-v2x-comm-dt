#!/usr/bin/env python3
"""
Open the closer V2V visualization in the default browser
"""
...
def open_closer_visualization():
    """Open the closer V2V visualization HTML file"""
    
    html_file = "closer_v2v_visualization.html"
    
    if not os.path.exists(html_file):
        print(f"❌ Error: {html_file} not found!")
        print("Please run extract_closer_vehicle_2_4_dataset.py first to create the dataset.")
        return False
    
    print("🌐 Opening closer V2V visualization...")
    ...
    print("✅ Closer visualization opened in your default browser!")
    print("\n📋 Instructions:")
