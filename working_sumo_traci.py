#!/usr/bin/env python3
"""
Working SUMO TraCI simulation using PC2 CSV data
...
class WorkingSUMOSimulation:
    ...
    def load_data(self):
        ...
        try:
            ...
            # Sample data for faster simulation (every 50th point)
    ...
    def update_vehicle_movement(self):
        ...
        speed_ms = max(0.1, speed_kmh / 3.6)  # Convert km/h to m/s, minimum 0.1 m/s
    ...
    def run_simulation(self):
        ...
        print("Starting Working SUMO TraCI simulation...")
        ...
        try:
            ...
            # Simulation loop
            max_steps = min(500, len(self.df))  # Limit simulation steps
...
def main():
    """Main function"""
    print("=== Working SUMO TraCI Simulation with PC2 Data ===\n")
    ...
    # Create minimal network if it doesn't exist
    if not os.path.exists('berlin_network.net.xml'):
        print("Network file not found. Creating minimal network...")
        from create_minimal_network import create_minimal_network
        create_minimal_network()
    
    # Create and run simulation
    simulation = WorkingSUMOSimulation('pc2_parsed.csv')
